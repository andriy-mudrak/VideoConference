...
namespace IdentityServerTest
{
    public class IdentityClaimsProfileService : IProfileService
    {
        ...
        public async Task GetProfileDataAsync(ProfileDataRequestContext context)
        {
            ...
            claims.Add(new Claim(ClaimConstants.ROLE, RoleConstants.USER));
            claims.Add(new Claim(ClaimConstants.ROLE, RoleConstants.ADMIN));
            claims.Add(new Claim(ClaimConstants.ROLE, RoleConstants.PREMIUM_USER));
